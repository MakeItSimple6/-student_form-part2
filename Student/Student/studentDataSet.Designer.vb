...
Partial Public Class studentDataSet
    ...
    Partial Public Class studentDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Overloads Function AddstudentRow(ByVal ID As Integer, ByVal student_name As String, ByVal dob As Date, ByVal gender As String, ByVal phone_no As String, ByVal address As String, ByVal image() As Byte) As studentRow
            Dim rowstudentRow As studentRow = CType(Me.NewRow,studentRow)
            Dim columnValuesArray() As Object = New Object() {ID, student_name, dob, gender, phone_no, address, image}
    ...
    Partial Public Class studentTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `student` WHERE ((`ID` = ?) AND ((? = 1 AND `student_name` IS NULL) O"& _ 
                "R (`student_name` = ?)) AND ((? = 1 AND `dob` IS NULL) OR (`dob` = ?)) AND ((? ="& _ 
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `student` (`ID`, `student_name`, `dob`, `gender`, `phone_no`, `addres"& _ 
                "s`, `image`) VALUES (?, ?, ?, ?, ?, ?, ?)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE `student` SET `ID` = ?, `student_name` = ?, `dob` = ?, `gender` = ?, `phon"& _ 
                "e_no` = ?, `address` = ?, `image` = ? WHERE ((`ID` = ?) AND ((? = 1 AND `student"& _ 
                "_name` IS NULL) OR (`student_name` = ?)) AND ((? = 1 AND `dob` IS NULL) OR (`dob"& _ 
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT ID, student_name, dob, gender, phone_no, address, [image] FROM student"
        ...
        Public Overloads Overridable Function Delete(ByVal Original_ID As Integer, ByVal Original_student_name As String, ByVal Original_dob As Date, ByVal Original_gender As String) As Integer
        ...
        Public Overloads Overridable Function Insert(ByVal ID As Integer, ByVal student_name As String, ByVal dob As Date, ByVal gender As String, ByVal phone_no As String, ByVal address As String, ByVal image() As Byte) As Integer
        ...
        Public Overloads Overridable Function Update(ByVal ID As Integer, ByVal student_name As String, ByVal dob As Date, ByVal gender As String, ByVal phone_no As String, ByVal address As String, ByVal image() As Byte, ByVal Original_ID As Integer, ByVal Original_student_name As String, ByVal Original_dob As Date, ByVal Original_gender As String) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Overloads Overridable Function Update(ByVal student_name As String, ByVal dob As Date, ByVal gender As String, ByVal phone_no As String, ByVal address As String, ByVal image() As Byte, ByVal Original_ID As Integer, ByVal Original_student_name As String, ByVal Original_dob As Date, ByVal Original_gender As String) As Integer
            Return Me.Update(Original_ID, student_name, dob, gender, phone_no, address, image, Original_ID, Original_student_name, Original_dob, Original_gender)
        End Function
    End Class
